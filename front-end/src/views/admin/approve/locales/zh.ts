export default {
  ...
  "searchTable.form.status.awaitingReview": "等待审核",
  "searchTable.form.status.passed": "已通过",
  "searchTable.form.status.rejected": "已拒绝",
  ...
  "searchTable.columns.pointsAwarded": "奖励点数",
